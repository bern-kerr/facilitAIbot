nome_robo = 'Manuel, o tuga'
nome_humano = 'Lu'
genero = 'mulher'
link_imagem='https://cdn.myportfolio.com/a2a38db7f580726e5d2fdb96e6ad25f7/31a3f081cecd82e3fb6e4db756726fc8a3e651946f224ab27f38b130de34c807e4cef86dcb56b67e_car_1x1.png?h=ecee4a39384a5aafbc3bf14b6dca94ce&url=aHR0cHM6Ly9taXItczMtY2RuLWNmLmJlaGFuY2UubmV0L3Byb2plY3RzL29yaWdpbmFsLzllMGQ0NjQ2OTg2NTY5LlkzSnZjQ3d4TVRrMUxEa3pOU3d4TURNc01BLnBuZw=='
...
def carrega_modelo(provedor, modelo, api_key, tipo_arquivo, arquivo, nome_robo, genero, nome_humano):
    ...
    system_message = '''Você é um assistente amigável chamado {}, feito para a {} chamada {}.
    ...
    que não foi capaz de carregar o vídeo e sugerir que o usuário tente novamente, ou tente carregar outro vídeo
